...
$PAGE->navbar->add(get_string('uploadpauta', 'mod_emarking'));
// Options for uploading the pdf file within the form.
$options = array(
    'subdirs' => 0,
...
if ($mform->is_cancelled()) {
    ...
    if ($file->get_mimetype() !== 'application/pdf') {
        ...
        echo $OUTPUT->error_text(get_string('fileisnotpdf', 'mod_emarking'));
